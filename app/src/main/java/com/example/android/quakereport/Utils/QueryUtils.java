...
public final class QueryUtils {
     ...
     */
    private static ArrayList<Earthquake> extractEarthquakes(String jsonReponse) {
        ...
        try {
            JSONObject jsonRootObject = new JSONObject(jsonReponse);
